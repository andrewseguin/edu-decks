...
function make3DCalcCard(settings: GeneratorSettings): GeometryCard {
  ...
  if (target === "vertices") {
    return {
      ...
      revealedPrompt: `A polyhedron has ${poly.F} faces, ${poly.E} edges, and ${poly.V} vertices.`,
      ...
      backSpeechText: `${poly.V} vertices. The polyhedron has ${poly.V} vertices`, numericAnswer: poly.V, color,
    };
  }
  ...
  if (target === "edges") {
    ...
    return {
      ...
      revealedPrompt: `A polyhedron has ${poly.V} vertices, ${poly.F} faces, and ${poly.E} edges.`,
      ...
      backSpeechText: `${poly.E} edges. The polyhedron has ${poly.E} edges`, numericAnswer: poly.E, color,
    };
  }
  ...
  return {
    ...
    revealedPrompt: `A polyhedron has ${poly.V} vertices, ${poly.E} edges, and ${poly.F} faces.`,
    ...
    backSpeechText: `${poly.F} faces. The polyhedron has ${poly.F} faces`, numericAnswer: poly.F, color,
  };
}
