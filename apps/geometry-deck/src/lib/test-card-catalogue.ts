...
export const TEST_CARDS: Record<string, GeometryCard> = {
  ...
  "calc-circle-circ": {
    ...
    backSteps: [
      { equationTokens: [t("lhs","C","#d8b4fe"), eq(), d("two","2π·"), t("r","r","#5ee8ff")], svgMutation: { traceStroke: "circumference" }, reason: "Circumference Formula" },
      { equationTokens: [t("lhs","C","#d8b4fe"), eq(), d("two","2π·"), t("r","4","#5ee8ff")], reason: "Substitute known values" },
      { equationTokens: [t("lhs","C","#d8b4fe"), eq(), t("rhs","8π","#d8b4fe")], reason: "Evaluate" },
    ],
  ...
  "calc-circle-r-from-c": {
    ...
    backSteps: [
      { equationTokens: [t("lhs","C","#d8b4fe"), eq(), d("two","2π·"), t("r","r","#5ee8ff")], reason: "Circumference Formula" },
      { equationTokens: [t("lhs","6π","#d8b4fe"), eq(), d("two","2π·"), t("r","r","#5ee8ff")], reason: "Substitute known values" },
      { equationTokens: [t("r","r","#5ee8ff"), eq(), t("lhs","6π","#d8b4fe"), op("÷"), d("two","2π")], reason: "Isolate the variable" },
  ...
  "calc-poly-angle-sum": {
    ...
    backSteps: [
      ...
      { equationTokens: [t("lhs","Sum"), eq(), t("tri","5","#5ee8ff"), op("·"), t("deg","180°")], reason: "Simplify expression" },
  ...
  "calc-3d-cylinder": {
    ...
    backSteps: [
      { equationTokens: [t("lhs","V"), eq(), d("pi","π·"), t("r","r²","#5ee8ff"), op("·"), t("h","h","#ffd45e")], reason: "Cylinder Volume Formula" },
      { equationTokens: [t("lhs","V"), eq(), d("pi","π·"), t("r","3²","#5ee8ff"), op("·"), t("h","4","#ffd45e")], reason: "Substitute known values" },
