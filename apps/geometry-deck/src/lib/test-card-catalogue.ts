...
export const TEST_CARDS: Record<string, GeometryCard> = {
  ...
  "calc-tri-angle-sum": {
    ...
    backSteps: [
      { equationTokens: [t("A","A","#5ee8ff"), d("p1"," + "), t("B","B","#ffd45e"), d("p2"," + "), t("C","C","#fb7185"), eq(), t("sum","180°")], reason: "Triangle angle sum theorem" },
      { equationTokens: [t("A","40°","#5ee8ff"), d("p1"," + "), t("B","65°","#ffd45e"), d("p2"," + "), t("C","C","#fb7185"), eq(), t("sum","180°")], reason: "Substitute known values" },
      { equationTokens: [t("lhs","C","#fb7185"), eq(), t("r1","180°"), op("−"), t("r2","40°","#5ee8ff"), op("−"), t("r3","65°","#ffd45e")], reason: "Isolate C" },
      { equationTokens: [t("lhs","C","#fb7185"), eq(), t("rhs","75°","#fb7185")], reason: "Evaluate" },
    ],
    backSpeechText: "C equals 75 degrees", numericAnswer: 75,
  },
  ...
  "calc-tri-perimeter": {
    ...
    backSteps: [
      { equationTokens: [t("lhs","P"), eq(), t("a","a","#5ee8ff"), op("+"), t("b","b","#ffd45e"), op("+"), t("c","c","#fb7185")], svgMutation: { traceStroke: "perimeter" }, reason: "Triangle perimeter formula" },
      { equationTokens: [t("lhs","P"), eq(), t("a","5","#5ee8ff"), op("+"), t("b","7","#ffd45e"), op("+"), t("c","9","#fb7185")], reason: "Substitute known values" },
  ...
  "calc-tri-pyth-c": {
    ...
    backSteps: [
      { equationTokens: [t("a","a²","#5ee8ff"), op("+"), t("b","b²","#ffd45e"), eq(), t("c","c²","#fb7185")], reason: "Pythagorean theorem" },
      { equationTokens: [t("a","3²","#5ee8ff"), op("+"), t("b","4²","#ffd45e"), eq(), t("c","c²","#fb7185")], reason: "Substitute known values" },
      { equationTokens: [t("a","9","#5ee8ff"), op("+"), t("b","16","#ffd45e"), eq(), t("c","25","#fb7185")], svgMutation: { traceStroke: "hypotenuse" }, reason: "Square both values" },
      { equationTokens: [t("c","c","#fb7185"), eq(), t("rhs","5","#fb7185")], reason: "Take the square root" },
    ],
  ...
  "calc-tri-pyth-b": {
    ...
    backSteps: [
      { equationTokens: [t("a","a²","#5ee8ff"), op("+"), t("b","b²","#ffd45e"), eq(), t("c","c²","#fb7185")], reason: "Pythagorean theorem" },
      { equationTokens: [t("a","a²","#5ee8ff"), op("+"), t("b","5²","#ffd45e"), eq(), t("c","13²","#fb7185")], reason: "Substitute known values" },
      { equationTokens: [t("a","a²","#5ee8ff"), eq(), t("c","169","#fb7185"), op("−"), t("b","25","#ffd45e"), eq(), t("ans","144","#5ee8ff")], reason: "Isolate a²" },
