...
export const TEST_CARDS: Record<string, GeometryCard> = {
  ...
  "term-angle-acute": {
    ...
    backSteps: [{ delayMs: 0, formulaLine: "0° < acute < 90°" }],
  ...
  "term-angle-obtuse": {
    ...
    backSteps: [{ delayMs: 0, formulaLine: "90° < obtuse < 180°" }],
  ...
  "term-angle-reflex": {
    ...
    backSteps: [{ delayMs: 0, formulaLine: "180° < reflex < 360°" }],
  ...
  "term-angle-complementary": {
    ...
    backSteps: [
      { delayMs: 0, formulaLine: "A + B = 90°" },
      { delayMs: 600, formulaLine: "e.g. 30° + 60° = 90°" },
    ],
  ...
  "term-angle-supplementary": {
    ...
    backSteps: [
      { delayMs: 0, formulaLine: "A + B = 180°" },
      { delayMs: 600, formulaLine: "e.g. 120° + 60° = 180°" },
    ],
  ...
  "term-angle-vertically-opp": {
    ...
    backSteps: [
      { delayMs: 0, formulaLine: "A = C,   B = D" },
      { delayMs: 600, formulaLine: "A + B = 180° (supplementary)" },
    ],
  ...
  "term-angle-alternate": {
    ...
    backSteps: [
      { delayMs: 0, formulaLine: "Z-angle pattern" },
      { delayMs: 600, formulaLine: "alternate angles are equal" },
    ],
  ...
  "term-angle-cointerior": {
    ...
    backSteps: [
      { delayMs: 0, formulaLine: "C-angle pattern" },
      { delayMs: 600, formulaLine: "A + B = 180°" },
    ],
  ...
  "calc-angle-supplementary": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","A"), d("op","+"), t("mid","B"), eq(), t("sum","180°")], svgMutation: { drawAngleArc: "A" }, reason: "Supplementary angles sum to 180°" },
      { delayMs: 600, equationTokens: [t("lhs","65°"), d("op","+"), t("mid","B"), eq(), t("sum","180°")], reason: "Substitute A = 65°" },
      { delayMs: 1200, equationTokens: [t("lhs","B"), eq(), t("rhs","180° − 65°")], svgMutation: { drawAngleArc: "B" }, reason: "Isolate B" },
      { delayMs: 1800, equationTokens: [t("lhs","B"), eq(), t("rhs","115°")], reason: "Evaluate" },
    ],
  ...
  "calc-angle-complementary": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","A"), d("op","+"), t("mid","B"), eq(), t("sum","90°")], svgMutation: { drawAngleArc: "A" }, reason: "Complementary angles sum to 90°" },
      { delayMs: 600, equationTokens: [t("lhs","35°"), d("op","+"), t("mid","B"), eq(), t("sum","90°")], reason: "Substitute A = 35°" },
      { delayMs: 1200, equationTokens: [t("lhs","B"), eq(), t("rhs","90° − 35°")], svgMutation: { drawAngleArc: "B" }, reason: "Isolate B" },
      { delayMs: 1800, equationTokens: [t("lhs","B"), eq(), t("rhs","55°")], reason: "Evaluate" },
    ],
  ...
  "calc-angle-vertically-opp": {
    ...
    color: TOPIC_COLORS.angles,
    frontSvg: { shape: "angle-vertically-opposite", dimensions: { A: 75 }, labelMode: "numeric", unknownDimension: "C" },
    frontSpeechText: "A is 75 degrees. Find vertically opposite angle C.",
    backSteps: [
      { delayMs: 0, formulaLine: "Vertically opposite angles are equal", reason: "Theorem" },
      { delayMs: 700, equationTokens: [t("lhs","C"), eq(), t("mid","A"), eq("eq2"), t("rhs","75°")], reason: "Vertically opposite angles are equal" },
    ],
  ...
  "term-tri-equilateral": {
    ...
    backSteps: [{ delayMs: 0, formulaLine: "All sides equal, all angles = 60°" }],
  ...
  "term-tri-isosceles": {
    ...
    backSteps: [{ delayMs: 0, formulaLine: "2 equal sides → 2 equal base angles" }],
  ...
  "term-tri-scalene": {
    ...
    backSteps: [{ delayMs: 0, formulaLine: "All sides different, all angles different" }],
  ...
  "term-tri-right": {
    ...
    backSteps: [{ delayMs: 0, formulaLine: "One angle = 90° (right angle)" }],
  ...
  "term-tri-angle-sum": {
    ...
    backSteps: [
      { delayMs: 0, formulaLine: "A + B + C = 180°" },
      { delayMs: 600, formulaLine: "e.g. 60° + 70° + 50° = 180°" },
    ],
  ...
  "term-tri-pythag": {
    ...
    backSteps: [
      { delayMs: 0, formulaLine: "a² + b² = c²" },
      { delayMs: 700, formulaLine: "c is always the hypotenuse" },
      { delayMs: 1400, formulaLine: "c = √(a² + b²)" },
    ],
    backSpeechText: "The Pythagorean theorem states a squared plus b squared equals c squared",
  },

  // ──────────────────────────────────────────────────────────────────────────
  // TRIANGLES — FORMULA CARDS
  // ──────────────────────────────────────────────────────────────────────────

  "formula-tri-area": {
    id: "formula-tri-area", topic: "triangles", cardType: "formula", variant: "formula-recall",
    color: TOPIC_COLORS.triangles,
    frontSvg: { shape: "triangle", dimensions: { b: "b", h: "h", style: "scalene", labelMode: "variable" }, labelMode: "variable", unknownDimension: "A" },
    frontSpeechText: "Find the formula for the area of a triangle.",
    backFormula: "A = ½bh",
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","A"), eq(), t("rhs","½ × base × height")], svgMutation: { fillInterior: true }, reason: "Triangle area formula" },
      { delayMs: 700, equationTokens: [t("lhs","A"), eq(), t("rhs","½bh")], reason: "Simplify" },
    ],
    backSpeechText: "A equals one half base times height",
  },

  "formula-tri-perim": {
    id: "formula-tri-perim", topic: "triangles", cardType: "formula", variant: "formula-recall",
    color: TOPIC_COLORS.triangles,
    frontSvg: { shape: "triangle", dimensions: { a: "a", b: "b", c: "c", style: "scalene", labelMode: "variable" }, labelMode: "variable", unknownDimension: "P" },
    frontSpeechText: "Find the formula for the perimeter of a triangle.",
    backFormula: "P = a + b + c",
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","P"), eq(), t("rhs","a + b + c")], svgMutation: { traceStroke: "perimeter" } },
    ],
    backSpeechText: "P equals a plus b plus c",
  },

  "formula-tri-pyth": {
    id: "formula-tri-pyth", topic: "triangles", cardType: "formula", variant: "formula-recall",
    color: TOPIC_COLORS.triangles,
    frontSvg: { shape: "right-triangle", dimensions: { a: "a", b: "b", labelMode: "variable" }, labelMode: "variable", unknownDimension: "c" },
    frontSpeechText: "Find the hypotenuse c of a right triangle.",
    backFormula: "c = √(a² + b²)",
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","a² + b²"), eq(), t("rhs","c²")] },
      { delayMs: 700, equationTokens: [t("lhs","a² + b²"), eq(), t("rhs","c²")], svgMutation: { traceStroke: "hypotenuse" } },
      { delayMs: 1400, equationTokens: [t("lhs","c"), eq(), t("rhs","√(a² + b²)")] },
    ],
    backSpeechText: "c equals the square root of a squared plus b squared",
  },
  ...
  "calc-tri-angle-sum": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("A","A"), d("p1","+"), t("B","B"), d("p2","+"), t("C","C"), eq(), t("sum","180°")], reason: "Triangle angle sum theorem" },
      { delayMs: 600, equationTokens: [t("A","40°"), d("p1","+"), t("B","65°"), d("p2","+"), t("C","C"), eq(), t("sum","180°")], reason: "Substitute A = 40°, B = 65°" },
      { delayMs: 1200, equationTokens: [t("lhs","C"), eq(), t("rhs","180° − 40° − 65°")], reason: "Isolate C" },
      { delayMs: 1800, equationTokens: [t("lhs","C"), eq(), t("rhs","75°")], reason: "Evaluate" },
    ],
    backSpeechText: "C equals 75 degrees", numericAnswer: 75,
  },
  ...
  "calc-tri-area": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","A"), eq(), t("rhs","½ × b × h")], reason: "Triangle area formula" },
      { delayMs: 600, equationTokens: [t("lhs","A"), eq(), t("rhs","½ × 8 × 5")], svgMutation: { fillInterior: true }, reason: "Substitute b = 8, h = 5" },
      { delayMs: 1200, equationTokens: [t("lhs","A"), eq(), t("rhs","20")], reason: "Evaluate" },
    ],
  ...
  "calc-tri-perimeter": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","P"), eq(), t("rhs","a + b + c")], svgMutation: { traceStroke: "perimeter" }, reason: "Perimeter = sum of all sides" },
      { delayMs: 700, equationTokens: [t("lhs","P"), eq(), t("rhs","5 + 7 + 9")], reason: "Substitute the side lengths" },
      { delayMs: 1400, equationTokens: [t("lhs","P"), eq(), t("rhs","21")], reason: "Evaluate" },
    ],
  ...
  "calc-tri-pyth-c": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","a² + b²"), eq(), t("rhs","c²")], reason: "Pythagorean theorem" },
      { delayMs: 600, equationTokens: [t("lhs","3² + 4²"), eq(), t("rhs","c²")], reason: "Substitute a = 3, b = 4" },
      { delayMs: 1200, equationTokens: [t("lhs","9 + 16"), eq(), t("rhs","25")], svgMutation: { traceStroke: "hypotenuse" }, reason: "Square both values" },
      { delayMs: 1800, equationTokens: [t("lhs","c"), eq(), t("rhs","5")], reason: "Take the square root" },
    ],
  ...
  "calc-tri-pyth-b": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","a² + b²"), eq(), t("rhs","c²")], reason: "Pythagorean theorem" },
      { delayMs: 600, equationTokens: [t("lhs","a² + 5²"), eq(), t("rhs","13²")], reason: "Substitute known values" },
      { delayMs: 1200, equationTokens: [t("lhs","a²"), eq(), t("rhs","169 − 25 = 144")], reason: "Isolate a²" },
      { delayMs: 1800, equationTokens: [t("lhs","a"), eq(), t("rhs","12")], svgMutation: { traceStroke: "hypotenuse" }, reason: "Take the square root" },
    ],
  ...
  "term-quad-parallelogram": {
    ...
    backSteps: [
      { delayMs: 0, formulaLine: "Opposite sides ∥ and equal" },
      { delayMs: 600, formulaLine: "Opposite angles equal" },
    ],
  ...
  "term-quad-rhombus": {
    ...
    backSteps: [
      { delayMs: 0, formulaLine: "All 4 sides equal" },
      { delayMs: 600, formulaLine: "Angles NOT necessarily 90°" },
    ],
  ...
  "term-quad-trapezoid": {
    ...
    backSteps: [{ delayMs: 0, formulaLine: "Exactly 1 pair of parallel sides" }],
    backSpeechText: "Trapezoids have exactly one pair of parallel sides",
  },

  // ──────────────────────────────────────────────────────────────────────────
  // QUADRILATERALS — FORMULA CARDS
  // ──────────────────────────────────────────────────────────────────────────

  "formula-quad-rect-area": {
    id: "formula-quad-rect-area", topic: "quadrilaterals", cardType: "formula", variant: "formula-recall",
    color: TOPIC_COLORS.quadrilaterals,
    frontSvg: { shape: "rectangle", dimensions: { labelMode: "variable" }, labelMode: "variable", unknownDimension: "A" },
    frontSpeechText: "Find the formula for the area of a rectangle.",
    backFormula: "A = l × w",
    backSteps: [{ delayMs: 0, formulaLine: "A = l × w", svgMutation: { fillInterior: true } }],
    backSpeechText: "A equals l times w",
  },

  "formula-quad-rect-perim": {
    id: "formula-quad-rect-perim", topic: "quadrilaterals", cardType: "formula", variant: "formula-recall",
    color: TOPIC_COLORS.quadrilaterals,
    frontSvg: { shape: "rectangle", dimensions: { labelMode: "variable" }, labelMode: "variable", unknownDimension: "P" },
    frontSpeechText: "Find the formula for the perimeter of a rectangle.",
    backFormula: "P = 2(l + w)",
    backSteps: [{ delayMs: 0, formulaLine: "P = 2(l + w)", svgMutation: { traceStroke: "perimeter" } }],
    backSpeechText: "P equals 2 times l plus w",
  },

  "formula-quad-para-area": {
    id: "formula-quad-para-area", topic: "quadrilaterals", cardType: "formula", variant: "formula-recall",
    color: TOPIC_COLORS.quadrilaterals,
    frontSvg: { shape: "parallelogram", dimensions: { b: "b", h: "h", labelMode: "variable" }, labelMode: "variable", unknownDimension: "A" },
    frontSpeechText: "Find the formula for the area of a parallelogram.",
    backFormula: "A = b × h",
    backSteps: [{ delayMs: 0, formulaLine: "A = b × h", svgMutation: { fillInterior: true } }],
    backSpeechText: "A equals b times h",
  },

  "formula-quad-trap-area": {
    id: "formula-quad-trap-area", topic: "quadrilaterals", cardType: "formula", variant: "formula-recall",
    color: TOPIC_COLORS.quadrilaterals,
    frontSvg: { shape: "trapezoid", dimensions: { a: "a", b: "b", h: "h", labelMode: "variable" }, labelMode: "variable", unknownDimension: "A" },
    frontSpeechText: "Find the formula for the area of a trapezoid.",
    backFormula: "A = ½(a + b)h",
    backSteps: [{ delayMs: 0, formulaLine: "A = ½(a + b)h", svgMutation: { fillInterior: true } }],
    backSpeechText: "A equals one half a plus b times h",
  },
  ...
  "calc-quad-rect-area": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","A"), eq(), t("rhs","l × w")], reason: "Rectangle area formula" },
      { delayMs: 600, equationTokens: [t("lhs","A"), eq(), t("rhs","7 × 4")], svgMutation: { fillInterior: true }, reason: "Substitute l = 7, w = 4" },
      { delayMs: 1200, equationTokens: [t("lhs","A"), eq(), t("rhs","28")], reason: "Evaluate" },
    ],
  ...
  "calc-quad-rect-perim": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","P"), eq(), t("rhs","2(l + w)")], svgMutation: { traceStroke: "perimeter" }, reason: "Rectangle perimeter formula" },
      { delayMs: 700, equationTokens: [t("lhs","P"), eq(), t("rhs","2(7 + 4)")], reason: "Substitute l = 7, w = 4" },
      { delayMs: 1400, equationTokens: [t("lhs","P"), eq(), t("rhs","22")], reason: "Evaluate" },
    ],
  ...
  "calc-quad-para-area": {
    ...
    frontSpeechText: "Base is 8, height is 5. Find the area.",
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","A"), eq(), t("rhs","b × h")], reason: "Parallelogram area formula" },
      { delayMs: 600, equationTokens: [t("lhs","A"), eq(), t("rhs","8 × 5")], svgMutation: { fillInterior: true }, reason: "Substitute b = 8, h = 5" },
      { delayMs: 1200, equationTokens: [t("lhs","A"), eq(), t("rhs","40")], reason: "Evaluate" },
    ],
  ...
  "calc-quad-trap-area": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","A"), eq(), t("rhs","½(a + b)h")], reason: "Trapezoid area formula" },
      { delayMs: 600, equationTokens: [t("lhs","A"), eq(), t("rhs","½(4 + 10) × 5")], svgMutation: { fillInterior: true }, reason: "Substitute a = 4, b = 10, h = 5" },
      { delayMs: 1200, equationTokens: [t("lhs","A"), eq(), t("rhs","35")], reason: "Evaluate" },
    ],
  ...
  "calc-quad-rect-reverse": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","A"), eq(), t("rhs","l × w")], reason: "Rectangle area formula" },
      { delayMs: 600, equationTokens: [t("lhs","24"), eq(), t("rhs","l × 4")], reason: "Substitute A = 24, w = 4" },
      { delayMs: 1200, equationTokens: [t("lhs","l"), eq(), t("rhs","24 ÷ 4")], reason: "Divide both sides by w" },
      { delayMs: 1800, equationTokens: [t("lhs","l"), eq(), t("rhs","6")], reason: "Evaluate" },
    ],
  ...
  "term-circle-circumference": {
    ...
    backSteps: [{ delayMs: 0, formulaLine: "C = distance around the circle", svgMutation: { traceStroke: "circumference" } }],
    backSpeechText: "Circumference is the distance around a circle",
  },
  ...
  "term-circle-pi": {
    ...
    backSteps: [
      { delayMs: 0, formulaLine: "π = C ÷ d" },
      { delayMs: 700, formulaLine: "π ≈ 3.14159…" },
    ],
  ...
  "term-circle-radius": {
    ...
    backSvgExamples: [{ shape: "circle", dimensions: { r: 5, labelMode: "numeric" }, labelMode: "numeric" }],
    backSteps: [{ delayMs: 0, formulaLine: "radius = centre to edge" }],
  ...
  "term-circle-diameter": {
    ...
    backSvgExamples: [{ shape: "circle", dimensions: { r: 5, showDiameter: 1, labelMode: "numeric" }, labelMode: "numeric" }],
    backSteps: [
      { delayMs: 0, formulaLine: "d = 2r" },
      { delayMs: 600, formulaLine: "diameter = 2 × radius" },
    ],
  ...
  "calc-circle-circ": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","C"), eq(), t("rhs","2πr")], svgMutation: { traceStroke: "circumference" }, reason: "Circumference (C) formula" },
      { delayMs: 700, equationTokens: [t("lhs","C"), eq(), t("rhs","2π × 4")], reason: "Substitute r = 4" },
      { delayMs: 1400, equationTokens: [t("lhs","C"), eq(), t("rhs","8π")], reason: "Evaluate" },
    ],
  ...
  "calc-circle-area": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","A"), eq(), t("rhs","πr²")], reason: "Circle area formula" },
      { delayMs: 700, equationTokens: [t("lhs","A"), eq(), t("rhs","π × 5²")], svgMutation: { fillInterior: true }, reason: "Substitute r = 5" },
      { delayMs: 1400, equationTokens: [t("lhs","A"), eq(), t("rhs","25π")], reason: "Evaluate" },
    ],
  ...
  "calc-circle-r-from-c": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","C"), eq(), t("rhs","2πr")], reason: "Circumference (C) formula" },
      { delayMs: 600, equationTokens: [t("lhs","6π"), eq(), t("rhs","2πr")], reason: "Substitute C = 6π" },
      { delayMs: 1200, equationTokens: [t("lhs","r"), eq(), t("rhs","6π ÷ 2π")], reason: "Divide both sides by 2π" },
      { delayMs: 1800, equationTokens: [t("lhs","r"), eq(), t("rhs","3")], reason: "Evaluate" },
    ],
  ...
  "calc-circle-r-from-a": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","A"), eq(), t("rhs","πr²")], reason: "Circle area formula" },
      { delayMs: 600, equationTokens: [t("lhs","9π"), eq(), t("rhs","πr²")], reason: "Substitute A = 9π" },
      { delayMs: 1200, equationTokens: [t("lhs","r²"), eq(), t("rhs","9")], reason: "Divide both sides by π" },
      { delayMs: 1800, equationTokens: [t("lhs","r"), eq(), t("rhs","√9 = 3")], reason: "Take the square root" },
    ],
    backSpeechText: "r equals 3", numericAnswer: 3,
  },
  ...
  "term-poly-regular": {
    ...
    backSteps: [{ delayMs: 0, formulaLine: "Equal sides + equal angles" }],
  ...
  "term-poly-interior-sum": {
    ...
    color: TOPIC_COLORS.polygons,
    frontLabel: "Interior angle sum", frontPrompt: "of a polygon is…?",
    frontSpeechText: "The interior angle sum of a polygon is…?",
    backDefinition: "(n − 2) × 180°",
    backSvgExamples: [{ shape: "polygon", dimensions: { n: 6, labelMode: "numeric" }, labelMode: "numeric" }],
    backSteps: [
      { delayMs: 0, formulaLine: "Sum = (n − 2) × 180°" },
      { delayMs: 600, formulaLine: "n = number of sides" },
    ],
  ...
  "calc-poly-perimeter": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","P"), eq(), t("rhs","n × s")], svgMutation: { traceStroke: "perimeter" }, reason: "Regular polygon perimeter" },
      { delayMs: 700, equationTokens: [t("lhs","P"), eq(), t("rhs","6 × 8")], reason: "Substitute n = 6, s = 8" },
      { delayMs: 1400, equationTokens: [t("lhs","P"), eq(), t("rhs","48")], reason: "Evaluate" },
    ],
  ...
  "calc-poly-angle-sum": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","Sum"), eq(), t("rhs","(n − 2) × 180°")], reason: "Interior angle sum formula" },
      { delayMs: 700, equationTokens: [t("lhs","Sum"), eq(), t("rhs","(7 − 2) × 180°")], reason: "Substitute n = 7" },
      { delayMs: 1400, equationTokens: [t("lhs","Sum"), eq(), t("rhs","5 × 180°")], reason: "Simplify bracket" },
      { delayMs: 2100, equationTokens: [t("lhs","Sum"), eq(), t("rhs","900°")], reason: "Evaluate" },
    ],
  ...
  "calc-poly-each-angle-hex": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","Sum"), eq(), t("rhs","(n − 2) × 180°")], reason: "Interior angle sum formula" },
      { delayMs: 600, equationTokens: [t("lhs","Sum"), eq(), t("rhs","720°")], reason: "Evaluate for n = 6" },
      { delayMs: 1200, equationTokens: [t("lhs","Each"), eq(), t("rhs","720° ÷ 6")], reason: "Divide by 6 sides" },
      { delayMs: 1800, equationTokens: [t("lhs","Each"), eq(), t("rhs","120°")], reason: "Evaluate" },
    ],
  ...
  "term-3d-face": {
    ...
    backSteps: [
      { delayMs: 0, formulaLine: "Face = flat surface" },
      { delayMs: 600, formulaLine: "A cube has 6 faces" },
    ],
  ...
  "term-3d-edge": {
    ...
    backSvgExamples: [{ shape: "prism", dimensions: { l: 4, w: 3, h: 2, labelMode: "numeric" }, labelMode: "numeric" }],
    backSteps: [
      { delayMs: 0, formulaLine: "Edge = line where 2 faces meet" },
      { delayMs: 600, formulaLine: "A cube has 12 edges" },
    ],
  ...
  "term-3d-vertex": {
    ...
    backSvgExamples: [{ shape: "prism", dimensions: { l: 4, w: 3, h: 2, labelMode: "numeric" }, labelMode: "numeric" }],
    backSteps: [
      { delayMs: 0, formulaLine: "Vertex = corner where edges meet" },
      { delayMs: 600, formulaLine: "A cube has 8 vertices" },
    ],
  ...
  "term-3d-euler": {
    ...
    backSteps: [
      { delayMs: 0, formulaLine: "V − E + F = 2" },
      { delayMs: 600, formulaLine: "V = vertices, E = edges, F = faces" },
    ],
  ...
  "calc-3d-prism": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","V"), eq(), t("rhs","l × w × h")], reason: "Rectangular prism volume" },
      { delayMs: 600, equationTokens: [t("lhs","V"), eq(), t("rhs","4 × 3 × 2")], reason: "Substitute l = 4, w = 3, h = 2" },
      { delayMs: 1200, equationTokens: [t("lhs","V"), eq(), t("rhs","24")], reason: "Evaluate" },
    ],
  ...
  "calc-3d-cylinder": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","V"), eq(), t("rhs","πr²h")], reason: "Cylinder volume formula" },
      { delayMs: 600, equationTokens: [t("lhs","V"), eq(), t("rhs","π × 3² × 4")], reason: "Substitute r = 3, h = 4" },
      { delayMs: 1200, equationTokens: [t("lhs","V"), eq(), t("rhs","36π")], reason: "Evaluate" },
    ],
  ...
  "calc-3d-euler": {
    ...
    backSteps: [
      { delayMs: 0, equationTokens: [t("lhs","V − E + F"), eq(), t("rhs","2")], reason: "Euler's formula" },
      { delayMs: 600, equationTokens: [t("lhs","V − 12 + 6"), eq(), t("rhs","2")], reason: "Substitute E = 12, F = 6" },
      { delayMs: 1200, equationTokens: [t("lhs","V − 6"), eq(), t("rhs","2")], reason: "Simplify" },
      { delayMs: 1800, equationTokens: [t("lhs","V"), eq(), t("rhs","8 vertices")], reason: "Solve for V" },
    ],
