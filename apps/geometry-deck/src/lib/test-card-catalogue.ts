...
export const TEST_CARDS: Record<string, GeometryCard> = {
  ...
  "formula-tri-area": {
    ...
    backFormula: "A = ½bh",
    backSteps: [
      { equationTokens: [t("lhs","A"), eq(), t("rhs","½ × base × height")], svgMutation: { fillInterior: true }, reason: "Triangle area formula" },
      { equationTokens: [t("lhs","A"), eq(), t("rhs","½bh")], reason: "Simplify" },
    ],
  ...
  "formula-tri-perim": {
    ...
    backFormula: "P = a + b + c",
    backSteps: [
      { equationTokens: [t("lhs","P"), eq(), t("rhs","a + b + c")], svgMutation: { traceStroke: "perimeter" } },
    ],
  ...
  "formula-tri-pyth": {
    ...
    backFormula: "c = √(a² + b²)",
    backSteps: [
      { equationTokens: [t("lhs","a² + b²"), eq(), t("rhs","c²")] },
      { equationTokens: [t("lhs","a² + b²"), eq(), t("rhs","c²")], svgMutation: { traceStroke: "hypotenuse" } },
      { equationTokens: [t("lhs","c"), eq(), t("rhs","√(a² + b²)")] },
    ],
  ...
  "calc-tri-area": {
    ...
    backSteps: [
      { equationTokens: [t("lhs","A"), eq(), t("rhs","½ × b × h")], reason: "Triangle area formula" },
  ...
  "calc-tri-perimeter": {
    ...
    backSteps: [
      { equationTokens: [t("lhs","P"), eq(), t("rhs","a + b + c")], svgMutation: { traceStroke: "perimeter" }, reason: "Perimeter = sum of all sides" },
      { equationTokens: [t("lhs","P"), eq(), t("rhs","5 + 7 + 9")], reason: "Substitute the side lengths" },
  ...
  "calc-tri-pyth-c": {
    ...
    backSteps: [
      { equationTokens: [t("lhs","a² + b²"), eq(), t("rhs","c²")], reason: "Pythagorean theorem" },
      { equationTokens: [t("lhs","3² + 4²"), eq(), t("rhs","c²")], reason: "Substitute a = 3, b = 4" },
      { equationTokens: [t("lhs","9 + 16"), eq(), t("rhs","25")], svgMutation: { traceStroke: "hypotenuse" }, reason: "Square both values" },
      { equationTokens: [t("lhs","c"), eq(), t("rhs","5")], reason: "Take the square root" },
    ],
  ...
  "calc-tri-pyth-b": {
    ...
    backSteps: [
      { equationTokens: [t("lhs","a² + b²"), eq(), t("rhs","c²")], reason: "Pythagorean theorem" },
      { equationTokens: [t("lhs","a² + 5²"), eq(), t("rhs","13²")], reason: "Substitute known values" },
      { equationTokens: [t("lhs","a²"), eq(), t("rhs","169 − 25 = 144")], reason: "Isolate a²" },
      { equationTokens: [t("lhs","a"), eq(), t("rhs","12")], svgMutation: { traceStroke: "hypotenuse" }, reason: "Take the square root" },
    ],
