...
export function GeometryCard({
  ...
  return (
    <FlashCardShell
          ...
          {card.frontSvg && (
            <div
              className={cn(
                ...
                isFlipped ? "max-w-[360px] max-h-[170px] sm:max-h-[190px]" : "max-w-[440px] max-h-[230px]"
              )}
            >
      ...
      revealContent={
        <div className="proof-table-container w-full flex-1 min-h-0 flex flex-col items-center justify-center">
          {isFlipped && (
