          ...
          className={cn(
            ...
            isDiagramVisible
              ? problem.hasConversion
                ? "-translate-y-16 sm:-translate-y-20 [@media(max-height:640px)]:-translate-y-14"
                : "-translate-y-14 sm:-translate-y-16 md:-translate-y-20 [@media(max-height:640px)]:-translate-y-12"
              : "translate-y-0"
          )}
        >
          {/* Main Equation Line */}
