...
export function VisualMath({ problem }: VisualMathProps) {
  ...
  // ADDITION (+): Group 1 + Group 2 (blocks vertically centered with + symbol)
  if (operation === '+') {
    return (
      <div className="flex justify-center items-center gap-2 sm:gap-3 p-2 sm:p-2.5 rounded-2xl bg-white/10 border border-white/20 max-w-full backdrop-blur-xs">
        {/* First Group */}
        <div className="flex flex-wrap gap-1 justify-center items-center max-w-[130px]">
        ...
        {/* Plus Symbol - Vertically Centered with Blocks */}
        <span className="text-white/80 font-bold text-sm sm:text-base leading-none select-none">
          +
        </span>
  ...
  if (operation === '-') {
    ...
    return (
      <div className="flex flex-wrap justify-center items-center gap-1 p-2 sm:p-2.5 rounded-2xl bg-white/10 border border-white/20 max-w-[280px] backdrop-blur-xs">
  ...
  if (operation === '×') {
    ...
    return (
      <div className="flex flex-wrap justify-center items-center gap-2 p-2 sm:p-2.5 rounded-2xl bg-white/10 border border-white/20 max-w-[320px] backdrop-blur-xs">
    ...
    return (
      <div className="flex flex-wrap justify-center items-center gap-2 p-2 sm:p-2.5 rounded-2xl bg-white/10 border border-white/20 max-w-[320px] backdrop-blur-xs">
        {Array.from({ length: groupCount }).map((_, gIdx) => (
          <div
            key={`dg-${gIdx}`}
            className="flex flex-wrap gap-1 p-1.5 rounded-xl bg-white/15 border border-white/25 justify-center items-center min-w-[32px]"
          >
